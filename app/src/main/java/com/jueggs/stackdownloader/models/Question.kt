...
class Question(val tags: List<String>, val owner: Owner?, val is_answered: Boolean, val view_count: Int, val answer_count: Int, val score: Int, val last_activity_date: Long,
               val creation_date: Long, val question_id: Long, val link: String, val title: String, var tagsLabel: String?, var creationLabel: String?, var answerLabel: String?, var scoreLabel: String?) {
    constructor() : this(arrayListOf(), null, false, INVALID_VALUE, INVALID_VALUE, INVALID_VALUE, INVALID_VALUE_L, INVALID_VALUE_L, INVALID_VALUE_L, EMPTY_STRING, EMPTY_STRING, null, null, null, null)
}